...
// MARK: - 📋 «Оperation 'Rodopy'🎬
/**
 Иоанна проговаривает Дьяволу изменённые данные шифра, чтобы запутать мафию. Программа собирает ложную фразу. Но если Дьявол допрашивает её о единицах измерения, код выбрасывает ошибку, а блок do-catch выводит книжный ответ Иоанны.
 */
 /* 🧩 Что тренируем
